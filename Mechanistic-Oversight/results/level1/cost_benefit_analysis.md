...
| **Training Time (CPU)** | **~45.0 s (~0.8 min)** | **56.4 s (~0.9 min)** | **0.8x training compute** |
| **Inference Latency** | **12.3 ms** | **1.1 ms** | **11.5x latency per token** |
| **Inference Throughput** | **1546.0 tok/s** | **17840.9 tok/s** | Trade speed for deliberation |
...
1. **Backpropagation Through Time (BPTT):**
   ...
   - **Cost:** Training takes **0.8x longer**, but yields an effective depth of **24 layers** out of a compact parameter budget.
...
2. **Parameter Efficiency vs. Sequential FLOPs:**
   ...
   - The cost is paid strictly at test-time compute: inference takes **11.5x longer** than a single forward pass.
...
---
*Generated by `train_comparative_baseline.py` on 2026-09-11 20:44:47*
