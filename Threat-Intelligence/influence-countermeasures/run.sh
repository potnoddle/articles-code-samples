...
echo "=========================================================="
echo "  Influence Countermeasures: Cognitive Defense Suite       "
echo "=========================================================="
...
if command -v python3 &>/dev/null; then
    (cd "$DIR/python-harness" && python3 run_influence_tests.py)
elif command -v python &>/dev/null; then
    (cd "$DIR/python-harness" && python run_influence_tests.py)
else
...
echo ""
echo "[+] Influence Countermeasures verification run completed successfully."
